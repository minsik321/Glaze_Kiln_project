...
export const RECIPE_CANDIDATES: ReadonlyArray<{
  ...
  { id: "coastal-satin", name: "해안 사틴 01", visual: "recipe-blue", similarityReason: "사틴 광택과 불투명 목표가 가장 가까움", firingRange: "1180–1230 °C", sourceType: "literature", dataCount: 3, uncertainty: "높음 · 실제 결과 사진 없음", risk: "흘러내림·균열은 판정 불가", photoAvailable: false, detail: "배합 퍼센트와 화학 상세는 문헌 원조건 확인 전 제품 판단에 사용하지 않습니다." },
  { id: "warm-clear", name: "웜 클리어 02", visual: "recipe-clear", similarityReason: "색상은 가깝지만 광택·투명도 차이가 큼", firingRange: "1200–1240 °C", sourceType: "patent_range", dataCount: 2, uncertainty: "높음 · 특정 실시 조건", risk: "현재 소지 조건 적용 가능성 판정 불가", photoAvailable: false, detail: "특허 범위를 일반 유약의 관측값으로 취급하지 않습니다." },
  { id: "soft-matte", name: "소프트 매트 03", visual: "recipe-white", similarityReason: "질감 사례는 가깝지만 목표 색상과 차이", firingRange: "1160–1220 °C", sourceType: "synthetic", dataCount: 0, uncertainty: "매우 높음 · 설명용 합성", risk: "실제 결함 위험 판정 불가", photoAvailable: false, detail: "규칙 비교용 합성 후보이며 실제 배합 또는 결과 예측이 아닙니다." },
] as const;
